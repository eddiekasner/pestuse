...
title: |
  ...
  | Franklin County, Washington 2014-2018
...
## Read 2014-2018 county-level estimates (Franklin County, WA subset only)
...
Franklin County ranks **#3 of Washington's 39 counties** by total
...
counties. Franklin County, also part of the Tri-Cities area, is irrigated Columbia Basin farmland producing potatoes, wheat, alfalfa, and seed crops.
...
**Franklin County, Washington** during `r recent_year`, as reported by
...
write.csv(county_top, "franklin.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Franklin County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
