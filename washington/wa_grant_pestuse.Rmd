...
title: |
  ...
  | Grant County, Washington 2014-2018
...
## Read 2014-2018 county-level estimates (Grant County, WA subset only)
...
Grant County ranks **#1 of Washington's 39 counties** by total
...
counties. Grant County sits in the heart of the Columbia Basin Project, where large-scale center-pivot irrigation supports potatoes, field corn, alfalfa hay, and wheat.
...
**Grant County, Washington** during `r recent_year`, as reported by
...
write.csv(county_top, "grant.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Grant County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
