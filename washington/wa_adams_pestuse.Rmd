...
title: |
  ...
  | Adams County, Washington 2014-2018
...
## Read 2014-2018 county-level estimates (Adams County, WA subset only)
...
Adams County ranks **#4 of Washington's 39 counties** by total
...
counties. Adams County is Columbia Basin wheat country, farmed under both dryland and irrigated systems, alongside potatoes and other irrigated row crops.
...
**Adams County, Washington** during `r recent_year`, as reported by
...
write.csv(county_top, "adams.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Adams County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
