...
title: |
  ...
  | Yakima County, Washington 2014-2018
...
## Read 2014-2018 county-level estimates (Yakima County, WA subset only)
...
Yakima County ranks **#5 of Washington's 39 counties** by total
...
counties. Yakima County is nationally known as the "Fruit Bowl of the Nation," a major tree-fruit region (apples, pears, cherries) and one of the country's leading hop-growing areas.
...
**Yakima County, Washington** during `r recent_year`, as reported by
...
write.csv(county_top, "yakima.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Yakima County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
