...
title: |
  ...
  | Oregon, Statewide Ranking 2014-2018
...
in Table \@ref(tab:class-key) and the full classification in
`data/pesticide_classification.csv`, shared unchanged with the Washington
pesticide class trends chapter). Rankings and estimates are
...
display <- st_top %>% select(-CLASS, -TYPE)
