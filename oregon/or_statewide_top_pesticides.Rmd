...
st_top <- st_ranked %>%
  ...
  select(RANK_1YR, COMPOUND, CLASS, EPEST_HIGH_KG_1YR, EPEST_HIGH_KG_3YR_AVG, EPEST_HIGH_KG_5YR_AVG)
```
...
mass applied, and each compound's organophosphate/carbamate classification
(see the Washington OP & carbamate trends chapter for the classification
methodology, which is reused unchanged here). Rankings and estimates are
