...
title: |
  ...
  | Umatilla County, Oregon 2014-2018
...
## Read 2014-2018 county-level estimates (Umatilla County, OR subset only)
...
Umatilla County ranks **#2 of Oregon's 36 counties** by total
...
counties. Umatilla County, adjoining Morrow County, is a major wheat producer and irrigated farming area near Hermiston, growing potatoes, onions, and watermelons.
...
**Umatilla County, Oregon** during `r recent_year`, as reported by
...
write.csv(county_top, "umatilla.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Umatilla County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
