...
title: |
  ...
  | Morrow County, Oregon 2014-2018
...
## Read 2014-2018 county-level estimates (Morrow County, OR subset only)
...
Morrow County ranks **#1 of Oregon's 36 counties** by total
...
counties. Morrow County, in the Columbia Basin/Columbia Plateau of north-central Oregon, is farmed under large-scale center-pivot irrigation around Boardman, producing potatoes, wheat, and alfalfa alongside significant food-processing activity.
...
**Morrow County, Oregon** during `r recent_year`, as reported by
...
write.csv(county_top, "morrow.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Morrow County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
