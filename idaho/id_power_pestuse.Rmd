...
## Read 2014-2018 county-level estimates (Power County, ID subset only)
...
Power County ranks **#2 of Idaho's 44 counties** by total
...
counties. Power County, on the Snake River Plain near American Falls, grows irrigated potatoes, wheat, alfalfa, and sugar beets.
...
**Power County, Idaho** during `r recent_year`, as reported by
...
write.csv(county_top, "power.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Power County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
