...
title: |
  ...
  | Jefferson County, Idaho 2014-2018
...
## Read 2014-2018 county-level estimates (Jefferson County, ID subset only)
...
Jefferson County ranks **#4 of Idaho's 44 counties** by total
...
counties. Jefferson County, in eastern Idaho near Rigby, grows irrigated potatoes, wheat, and barley alongside dairy operations.
...
**Jefferson County, Idaho** during `r recent_year`, as reported by
...
write.csv(county_top, "jefferson.pesticide.use.2014-2018.csv", row.names = FALSE)
```

```{r top-chart, include=T, fig.cap="Top 25 compounds in Jefferson County by EPest-high mass applied, most recent year, colored by pesticide functional class."}
