...
with each state's own chapters), and — for comparison — its
`r recent_year` rank *within each state considered alone*. Rankings and
...
display <- region_top %>% select(-CHEMICAL_CLASS, -FUNCTIONAL_CLASS)
...
```{r top-chart, include=T, fig.cap="Top 25 compounds region-wide by EPest-high mass applied, most recent year, colored by pesticide functional class."}
